...
namespace NagelSchreckenberg
{
	class Program
	{
		...
		public static void Main(string[] args)
		{
			...
			{
				Ausgabe.WriteLine("Neue Simulation gestartet (Vorbereitung 500 Schritte)");
				Ausgabe.WriteLine("");
			}
			using ( StreamWriter einfacheAusgabe = File.CreateText(einfacheAusgabePfad))
			{
				einfacheAusgabe.WriteLine("Neue Simulation gestartet (Vorbereitung 500 Schritte)");
			...
			for (int i = 0; i < 5000; i++) 						//500 mal durchlaufen von Simulationsschritten, ...
			{
